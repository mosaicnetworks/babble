...
application. Developers can focus on building their application logic and simply 
integrate Babble to handle the replication aspect. Basically, Babble will 
